...
namespace pokerbot3{
    ...
    static class Program
    {
        ...
        public static (int mainScore, long tieBreaker) getFullScore(ulong bf)
        {
            ...
            (int, long) result = (getMainScore(solo,ranksField,flush), getTieBreaker(ranksField));
        ...
        static void Main(string[] args)
        {
            ...
            int[] tableCardSuits2 = new int[] { 1, 3, 0,2 };
            int[] tableCardRanks2 = new int[] { 2, 9, 11,12 };
            ...
            List<KeyValuePair<int, int>> tableCards3 = new List<KeyValuePair<int, int>>();
            int[] tableCardSuits3 = new int[] { 1, 3, 0, 2,0 };
            int[] tableCardRanks3 = new int[] { 2, 9, 11, 12,14 };
            for (int i = 0; i < 5; i++)
            {
                tableCards3.Add(new KeyValuePair<int, int>(tableCardRanks3[i], tableCardSuits3[i]));
            }
            ...
            Console.WriteLine(GetOdds(myHoleCards, tableCards));
            Console.WriteLine("first calculation done");
            Console.WriteLine(GetOdds(myHoleCards, tableCards2));
            Console.WriteLine("second calculation done");
            Console.WriteLine(GetOdds(myHoleCards, tableCards3));
            Console.WriteLine("last calculation done");
