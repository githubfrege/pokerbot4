...
namespace pokerbot3
{
    ...
    static class Program
    {
        ...
        private static int getHighestRank(ulong allCards)
        {
        ...
        public static (int mainScore, long tieBreaker) getScore(ulong bf)
        {
            ...
            (int, long) result = (score, getTieBreaker(ranksField));
        ...
        private static (int mainScore, long tieBreaker) handToPlay(ulong holes, ulong cardsOnTable)
        {
            ...
            foreach (ulong combo in cardCombos(cardsOnTable.ToIEnum(), 4))
            {
                ...
                {
                    (int mainScore, long tieBreaker) currentScore = getScore(combo | holeCard);
                    if ((currentScore.mainScore.CompareTo(max.mainScore) != 0 ? currentScore.mainScore.CompareTo(max.mainScore) : currentScore.tieBreaker.CompareTo(max.tieBreaker)) > 0)
                    {
                        max = currentScore;
                    }
        ...
        {
            int[] holeCardSuits = new int[] { 2, 1 };
            int[] holeCardRanks = new int[] { 10, 7 };
            int[] tableCardSuits = new int[] { 0, 3, 1, };
            int[] tableCardRanks = new int[] { 2,3,4};
            ...
            int[] tableCardSuits2 = new int[] { 0, 0, 0,3,0};
            int[] tableCardRanks2 = new int[] {2, 3, 14,2,6 };
            ...
            ulong bf = parseAsBitField(tableCards2);
